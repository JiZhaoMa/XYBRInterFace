//饼图
function createPatentGroupByPerson(bar,person,dept,ptype,process,jiaoDiShuMonth,shouQuanMonth) {
    let xAxisData = ['汪易强','刘晋程','段江龙','高凯毅','杨峰','杨勇','王嘉力'];
    ...
    $.ajax({
        type: "GET",
        url: urls + "report/patent/getPatentByPerson",
